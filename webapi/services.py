...
def generate_response_case2(fen: str, list: list) -> str:
    ...
    list_all_moves = []
    list_all_variants = []
    list_strategies = [chess_functions.PAWN_ADVANCE_STRATEGY, chess_functions.DEFEND_PIECES_STRATEGY,
                       chess_functions.TAKE_PIECES_STRATEGY, chess_functions.ATTACK_PIECES_STRATEGY,
        ...
        if move in bad_move:
            ...
            for algorithm in algorithms:
                ...
                for move_algorithm, score in algorithm[1]:
                    if color_pos % 2 == 0:
                        m += 1
                        information_move = output.create_json_information_moves(color[color_pos] + move_algorithm,
                                                                                score)
                ...
                if n == 3:
                    ...
                    list_all_moves.append(output.create_json_information_moves_with_variants(move,
            ...
            list_all_moves.append(output.create_json_information_moves(move,
                                                                       chess_functions.evaluate_board_state(board, move,
                                                                                                            list_strategies)))
        board.push_uci(move)
